...
2. Fix all Critical and Important issues directly by editing the files
3. Log Minor issues in your report but don't fix them unless trivial
...
- **Escalate blockers.** If you find a fundamental design flaw, report it to the orchestrator rather than attempting a large redesign.
